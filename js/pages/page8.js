// js/pages/page8.js (修改版 - 适配新HTML结构)
...
(() => {
    ...
    function renderChangeRateChart() { 
        ...
        page8_container.querySelector('#show-change-rate').classList.add('active'); 
        page8_container.querySelector('#show-composition').classList.remove('active'); 
    }
    
    function renderCompositionChart() { 
        myChart.setOption(optionComposition, true); 
        page8_container.querySelector('#show-composition').classList.add('active'); 
        page8_container.querySelector('#show-change-rate').classList.remove('active'); 
    }
    
    // 添加事件监听器
    const changeRateBtn = page8_container.querySelector('#show-change-rate');
    const compositionBtn = page8_container.querySelector('#show-composition');
